...
public class SelectCredit extends AppCompatActivity {
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Toast.makeText(SelectCredit.this, "123", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void initView() {
        ...
        adapter1 = new SelectCredit.MyAdapter1();
    ...
    class MyAdapter1 extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            SelectCredit.ViewHolder1 viewHolder1;

            if (convertView == null) {
                convertView = LayoutInflater.from(SelectCredit.this).inflate(R.layout.item_class, parent, false);
                viewHolder1 = new SelectCredit.ViewHolder1();
                ...
                viewHolder1 = (SelectCredit.ViewHolder1) convertView.getTag();
            }
