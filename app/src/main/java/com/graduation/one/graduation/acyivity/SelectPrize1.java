...
public class SelectPrize1 extends AppCompatActivity {
                    ...
                    public void onResponse(String response, int id) {
                        try {
                            ...
                            if (sucessed) {
                                ...
                                if (data.length() == 0) {
                                    Toast.makeText(SelectPrize1.this, "您暂无成绩", Toast.LENGTH_SHORT).show();
                                } else {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            SelectPrize1.ViewHolder viewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(SelectPrize1.this).inflate(R.layout.item_message, parent, false);
                viewHolder = new SelectPrize1.ViewHolder();
                ...
                viewHolder = (SelectPrize1.ViewHolder) convertView.getTag();
            }
